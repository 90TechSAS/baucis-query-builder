...
var app = angular.module('myApp', ['ngRoute', 'ngSanitize', 'ngTouch', //additional angular modules
'90TechSAS.baucis-query-builder']);

app.config(['$routeProvider', '$locationProvider', '$compileProvider', function ($routeProvider, $locationProvider) {
        /**
...
app.config(["zlQueryBuilderProvider", function (zlQueryBuilderProvider) {
